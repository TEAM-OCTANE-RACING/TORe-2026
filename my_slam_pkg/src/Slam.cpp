...
public:
    EUFSGraphSlam() : Node("eufs_graph_slam_node") {
        ...
        map_T_odom_ = Pose2(0, 0, 0); // The core map-to-odom coordinate transform
...
private:
    void odomCallback(const nav_msgs::msg::Odometry::SharedPtr msg) {
        ...
        current_odom_twist_ = msg->twist.twist; // Fixed Twist mapping
        ...
        // PERFECT LOCALIZATION FIX: Map pose is instantly derived from the exact TF offset!
        // This runs at 50Hz with 0.0ms of latency, ignoring optimization bottlenecks.
    ...
    void coneCallback(const eufs_msgs::msg::ConeArrayWithCovariance::SharedPtr msg) {
        ...
        if (batch_counter_ >= 3 || loop_closure_shockwave) {
            try {
                ...
                // THE TIME-TRAVEL BUG FIX: We do NOT overwrite latest_predicted_pose_ here.
                // We strictly extract the optimized offset matrix!
