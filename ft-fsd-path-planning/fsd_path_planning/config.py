...
def get_cone_sorting_config(
    ...
    return dict(
        ...
        max_length=15,
        threshold_directional_angle=np.deg2rad(90),
        threshold_absolute_angle=np.deg2rad(90),
...
def get_cone_fitting_config(
    ...
    return dict(smoothing=0.8, predict_every=0.1, max_deg=3)
...
def get_default_matching_kwargs(mission: MissionTypes) -> KwargsType:
    ...
    return dict(
        min_track_width=3,
        max_search_range=10,
        max_search_angle=np.deg2rad(80),
