...
HAL_TIM_PWM_Start(&htim1,TIM_CHANNEL_2);
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		...
		// READ SENSOR
		float temp_1 = ((float) adc_buff[ADC_THERM1_INDEX] / ADC_MAX_VAL)
				* TEMP_MAX_VAL;
		float temp_2 = ((float) adc_buff[ADC_THERM2_INDEX] / ADC_MAX_VAL)
				* TEMP_MAX_VAL;
		float temp_3 = ((float) adc_buff[ADC_THERM3_INDEX] / ADC_MAX_VAL)
				* TEMP_MAX_VAL;
		float temp_4 = ((float) adc_buff[ADC_THERM4_INDEX] / ADC_MAX_VAL)
				* TEMP_MAX_VAL;
		stator_temp = temp_1;
